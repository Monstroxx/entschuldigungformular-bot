#!/bin/bash
# Docker Fixed Script - löst SQLite Probleme mit Volume

echo "🔧 Docker Fixed - löst SQLite Probleme..."
...
if [ ! -f ".env" ]; then
    ...
    echo "3. Führe ./docker-fixed.sh erneut aus"
    exit 0
fi
...
echo "✅ Docker Fixed abgeschlossen"
